...
def attack(char_name: str, char_class: str) -> str:
    """Атака. Изменение характеристик прсонажа в случае атаки."""
...
def defence(char_name: str, char_class: str) -> str:
    """Защита. Изменение характеристик прсонажа в случае атаки."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Спец. умение. Изменение характеристик прсонажа в случае спец. умения."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выбор и подтверждение типа персонажа."""
    approve_choice: str = ''
    char_class: str = ''
